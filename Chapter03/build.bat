...
if "%1" == "test"  goto TEST
if "%1" == "msvc140" shift &&   call :SET_VS_VARS msvc140 && goto PROCEED
...
if not "%VS140COMNTOOLS%" == "" call :SET_VS_VARS msvc140 && goto PROCEED
...
if "%1" == "msvc140" call "%VS140COMNTOOLS%vsvars32.bat" > build.log && echo Using MS Visual C++ 14.0
